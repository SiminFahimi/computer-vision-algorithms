...
def run_detector():
    ...
    template_paths=[]
    template_paths.append(["data/a.png", "data/a1.png", "data/a2.png", "data/a3.png"])
    template_paths.append(["data/b.png", "data/b1.png", "data/b2.png", "data/b3.png"])
    template_paths.append(["data/c.png", "data/c1.png", "data/c2.png", "data/c3.png"])

    for i in  range (len(template_paths)):
        templates = [cv2.imread(p, cv2.IMREAD_GRAYSCALE).astype(np.float32) 
                    for p in template_paths[i] if cv2.imread(p) is not None]
        ...
        cv2.imwrite(f"results/detection_result{i}.png",image_vis)
